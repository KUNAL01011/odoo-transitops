...
export const mockTrips: Trip[] = [
  {
    ...
    dispatchedAt: "2026-07-12T08:05:00Z",
    completedAt: null,
    cancelledAt: null,
  },
  {
    ...
    status: "DISPATCHED",
    cancellationReason: null,
    dispatchedAt: "2026-07-12T06:30:00Z",
    completedAt: null,
    cancelledAt: null,
  },
  {
  ...
  },
  {
    ...
    dispatchedAt: "2026-07-11T09:15:00Z",
    completedAt: null,
    cancelledAt: "2026-07-11T10:00:00Z",
  },
  {
    id: 5,
    tripCode: "TR005",
    ...
    status: "COMPLETED",
    cancellationReason: null,
    dispatchedAt: "2026-07-11T07:00:00Z",
    completedAt: "2026-07-11T08:40:00Z",
    cancelledAt: null,
  },
  {
    id: 6,
    ...
    status: "COMPLETED",
    cancellationReason: null,
    dispatchedAt: "2026-07-08T06:00:00Z",
    completedAt: "2026-07-08T09:20:00Z",
    cancelledAt: null,
  },
  {
    id: 7,
    ...
    status: "COMPLETED",
    cancellationReason: null,
    dispatchedAt: "2026-07-10T07:30:00Z",
    completedAt: "2026-07-10T08:45:00Z",
    cancelledAt: null,
  },
];
...
export const mockNotifications: Notification[] = [
  {
    ...
    message:
      "Driver John's HMV license expired on 20 Mar 2025 — reinstatement blocked until renewed.",
    isRead: false,
  ...
  },
  {
    ...
    message: "TR001 dispatched — VAN-05 / Alex, ETA 45 min.",
    isRead: true,
  ...
  },
  {
    ...
    message: "MINI-03 flagged for Tyre Replace — status set to In Shop.",
    isRead: false,
  ...
  },
  {
    ...
    role: "FINANCIAL_ANALYST",
    type: "TRIP_COMPLETED",
    message: "TR005 completed — fuel and odometer logged for VAN-12.",
    isRead: false,
  ...
  },
  {
    ...
    role: "DISPATCHER",
    type: "TRIP_CANCELLED",
    message: "TR004 cancelled — vehicle went to shop mid-dispatch.",
    isRead: true,
  ...
  },
  {
    ...
    role: "SAFETY_OFFICER",
    type: "LICENSE_EXPIRING",
    message: "Driver Priya Verma's license expires in 34 days (15 Aug 2026).",
    isRead: false,
